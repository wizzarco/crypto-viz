<template>
    <footer class="bg-gray-800" aria-labelledby="footer-heading">
      ...
      <div class="mx-auto max-w-7xl px-6 py-12 lg:px-8 lg:py-16">
        ...
        <div class="border-t border-gray-700 pt-8 lg:flex lg:items-center lg:justify-between xl:mt-0">
          ...
          <form class="mt-4 sm:flex sm:max-w-md lg:mt-0">
            ...
            <div class="mt-3 rounded-md sm:ml-3 sm:mt-0 sm:flex-shrink-0">
              <button type="submit" class="flex w-full items-center justify-center rounded-md border border-transparent bg-sky-500 px-4 py-2 text-base font-medium text-white hover:bg-sky-600 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2 focus:ring-offset-gray-800">Subscribe</button>
            </div>
          </form>
        </div>
        <div class="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
          ...
          <p class="mt-8 text-base text-gray-400 md:order-1 md:mt-0">&copy; 2024 Crypto Viz, Inc. All rights reserved.</p>
        </div>
      </div>
    </footer>
  </template>
  ...
  const navigation = {
    solutions: [
      ...
      { name: 'All crypto', href: '/all-crypto' },
      { name: 'Blog', href: '/blog' },
    ],
    support: [
      { name: 'Support', href: '/support' },
      { name: 'Documentation', href: '#' },
      { name: 'API Status', href: '/status-api' },
    ],
    legal: [
      { name: 'Claim', href: '#' },
      { name: 'Privacy', href: '#' },
