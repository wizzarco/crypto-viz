<template>
    ...
    <div class="relative flex mt-4">
        <div class="flex flex-col sm:flex-row items-center md:items-start sm:justify-center md:justify-start flex-auto">
            ...
            <img data-aos="fade-right" data-aos-delay="400" src="img/buy-and-trade.webp" class="-mt-4 h-72"/>
            <div data-aos="fade-right" data-aos-delay="400" class="sm:text-4xl xl:text-5xl font-bold leading-tight mb-6">Cryptocoin</div>
            <div data-aos="fade-up" data-aos-delay="600" class="sm:text-sm xl:text-md text-gray-200 font-normal">Log in to access the dashboard of our website and enjoy maximum trading on popular cryptocurrencies.</div>
            </div>
            <!--- Style fond -->
            <ul class="circles">
                <li></li>
        ...
        <div data-aos="fade-up" data-aos-delay="600" class="md:flex md:items-center md:justify-center w-full sm:w-auto md:h-full w-2/5 xl:w-2/5 p-8  md:p-10 lg:p-14 sm:rounded-lg md:rounded-none">
            ...
            <form class="mt-8 space-y-6" method="POST">
                <div class="relative">
                    ...
                    <input id="EMAIL" name="EMAIL" class=" w-full text-base px-4 py-2 border-b border-gray-300 focus:outline-none rounded-2xl focus:border-indigo-500" type="email" placeholder="Email account">
                </div>
                <div class="mt-8 content-center">
                    <label class="ml-3 text-sm font-bold text-gray-700 tracking-wide">Password</label>
                    <div class="relative">
                        <input :type="this.$store.state.togglePassword ? 'text' : 'password'" id="PASSWORD" name="PASSWORD" class="w-full content-center text-base px-4 py-2 border-b rounded-2xl border-gray-300 focus:outline-none focus:border-indigo-500" placeholder="Enter ur password">
